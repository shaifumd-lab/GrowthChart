...
def get_velocity_reference_curves(sex: str) -> List[dict]:
    ...
    band_defs = [
        (3, 10,  "rgba(254,202,202,0.25)"),
        (10, 25, "rgba(254,249,195,0.25)"),
        (25, 50, "rgba(209,250,229,0.30)"),
        (50, 75, "rgba(209,250,229,0.30)"),
        (75, 90, "rgba(254,249,195,0.25)"),
        (90, 97, "rgba(254,202,202,0.25)"),
    ]
